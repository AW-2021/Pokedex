...
const Navbar = () => {
  ...
  return (
    <Link
      ...
      className="fixed top-2 right-2 sm:top-0 sm:right-0 h-[min(18vw,12rem)] hover:h-[min(19vw,13rem)] hover:cursor-pointer hover:drop-shadow-2xl hover:drop-shadow-indigo-600 text-[0.8rem]"
    >
      {screenSize === "sm" ? (
