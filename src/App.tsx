...
const App = () => {
  ...
  const tableDataStyle: string = "border-2 border-gray-900 text-[min(2vw,1rem)] p-1 md:p-2 lg:p-3";
  ...
  return (
    <div className="bg-game-2 bg-fixed font-display h-screen w-full sm:h-full flex flex-col items-center ">
      <div
        ...
        className="fixed top-0 right-0 h-[min(15vh,12rem)] hover:h-52 hover:cursor-pointer hover:drop-shadow-2xl hover:drop-shadow-indigo-600 text-[0.8rem]"
      >
      ...
      >
        ...
        <div id="left-pokedex" className="h-full border-0 border-green-600 relative">
          ...
          <div id="form-div" className="absolute left-[14%] bottom-[9%] h-[27%] w-[46%] border-0 border-blue-600">
            <form id="search-form" onSubmit={fetchPokemon}>
              ...
              ><IoMdSearch className="h-[67%] w-full hover:h-[60%]" /></button>
            </form>
          </div>
        ...
        <div id="right-pokedex" className="h-full border-0 border-blue-700 relative">
          ...
          <div className="absolute top-[21.5%] left-[8%] h-[68%] w-[75%] bg-emerald-400 border-2 border-gray-900 rounded-2xl p-3 flex flex-col justify-around items-center inset-shadow-sm inset-shadow-black ">
            ...
            { pokemon?.stats &&
              <table className="w-full text-center text-gray-900">
                ...
                { pokemon?.stats.map((pokeStat, index) => (
                    <tr key={index}>
                      <td className={`${tableDataStyle} w-3/5 ${pokeStat.stat.name === "hp" ? "uppercase" : "capitalize"}`}>
